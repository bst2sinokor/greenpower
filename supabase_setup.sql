...
VALUES
    (1, 920739, '2010-01-01', '2020-12-31', '1단계 매립 (완료)'),
    (2, 827218, '2018-01-01', '2025-12-31', '2단계 매립 (대기)'),
    (3, 907785, '2023-01-01', '2030-12-31', '3단계 매립 (대기)'),
    (4, 1006092, '2028-01-01', '2038-12-31', '4단계 매립 (진행 중)')
...
INSERT INTO profiles (id, role, name) VALUES
    ('c1a9fa27-a6ef-4303-881f-529331a5bc15', 'entry', '이석근 상무'),
    ('ff2c6b0f-90d0-4a37-976b-f91230dd8e12', 'viewer', '정원균 팀장');
