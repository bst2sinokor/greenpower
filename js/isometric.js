...
const ISO = {
    ...
    getOffset() { return { x: this.W * 0.5, y: this.H * 0.58 }; },
    ...
    drawLegend(svg) {
        ...
        const x0=12, y0=this.H-98;
        svg.appendChild(this.createEl('text', {
            x:x0, y:y0-5, 'font-size':'10', 'font-weight':'700',
        ...
        items.forEach((item, i) => {
            ...
            if (item.dot) {
                ...
                svg.appendChild(this.createEl('rect', { x:x0, y:y-9, width:'12', height:'10', fill:item.color, rx:'2' }));
            }
            svg.appendChild(this.createEl('text', {
                x:x0+18, y:y, 'font-size':'10', fill:'#6b7280',
                'font-family':'Noto Sans KR, sans-serif'
            }, item.label));
        });
    },
